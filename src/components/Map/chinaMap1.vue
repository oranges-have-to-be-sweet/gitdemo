    ...
    >
      ...
      >
        ...
        <bm-control :offset="{ width: '10px', height: '10px' }">
          <bm-auto-complete v-model="keyword" :sugStyle="{ zIndex: 0 }">
            <el-input
      ...
      <el-row class="map_title">
        <el-col :span="12" class="map_title_span">
          <p class="map_p">
            经度：{{
              locationdata.center ? locationdata.center.lng : center.lng
            }}
          </p>
          <p class="map_p">
            纬度：{{
              locationdata.center ? locationdata.center.lat : center.lat
            }}
          </p>
        </el-col>
        <el-col :span="12">
          ...
          >
            <div>
              <p v-if="switchEdit">
                地址：<span>{{ locationdata.addr || "请标注地址" }}</span>
              </p>
            ...
            <div @click="switchEdit = !switchEdit">
              <el-button
                ...
                icon="el-icon-edit"
              ></el-button>
              <el-button v-else style="margin-left:20px;" type="text"
                >保存</el-button
              >
            </div>
          </div>
      ...
      <el-row>
        <el-col :offset="12" :span="4">
          <el-button type="primary" size="small" @click="getmapdamodata"
            >提交</el-button
          >
        </el-col>
      </el-row>
  ...
  watch: {
    mapData: {
      handler(val) {
        ...
        console.log(this.locationdata.center);
    ...
    BMap: {
      handler(val) {
        console.log(val);
        this.locationdata.center = new val.Point(
          this.locationdata.center.lng,
          this.locationdata.center.lat
        );
        // console.log(this.locationdata.center, "1111111111");
      }
    }
  },
  methods: {
