  ...
  <div>
    ...
    >
      ...
      <bm-control class="select">
        ...
        <div class="bname">
          <p>
            快教务共计 <span>{{ otherData.kjw }} 所</span> ，
          </p>
          <p>
            育幼通 <span>{{ otherData.yyt }} 所</span> ，
          </p>
          <p>
            全部学校共 <span>{{ otherData.suoYou }} 所</span>
          </p>
        </div>
      </bm-control>
      <bm-map-type
  ...
  methods: {
    draw({ el, BMap, map }) {
      const pixel = map.pointToOverlayPixel(
        new BMap.Point(116.404035, 39.916322)
      );
