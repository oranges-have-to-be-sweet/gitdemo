  ...
  <div id="statics">
    ...
    <el-row class="layout-row">
      ...
      <el-col :span="10" :offset="1">
        ...
        >
          <el-table-column prop="schoolName" align="center" label="学校名字">
          </el-table-column>
          <el-table-column
            prop="alreadyEntered"
            align="center"
          ...
          <el-table-column prop="rejection" align="center" label="拒收（人）">
          </el-table-column>
          <el-table-column prop="badLuck" align="center" label="总计（人）">
          </el-table-column>
        </el-table>
        <Pagination
          v-if="total > 0"
